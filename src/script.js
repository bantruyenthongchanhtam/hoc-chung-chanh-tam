...
======================= */
let allYears = MemberService.getAllYears(); // All available years / Tất cả năm khả dụng
...
function createClearButton() {
    ...
    if (!clearBtn) {
        ...
        clearBtn.className = "clear-search-btn absolute right-3 top-2.5 text-orange-400 hover:text-orange-600 text-lg";
        clearBtn.innerHTML = "✕";
